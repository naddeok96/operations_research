...
# Hyperparameters
tableau_names = ["Z", "x1", "x2", "x3", "x4", "x5", "x6", "|x7|", "|x8|", "RHS"]
M = 1e5
max_iter = 10
...
iteration = 0
tableaus.append(np.array( [[1, -15 - 4*M, 12 - 7*M, -6 + 2*M, 8-11*M,  M, 0, 0, 0, -54*M],
                          [0,         3,        2,       -4,      5,  -1, 0, 1, 0,    24],
                          [0,         1,        5,        2,      6,   0, 0, 0, 1,    30],
                          [0,         4,        0,        5,      0,   0, 1, 0, 0,    15]]))
